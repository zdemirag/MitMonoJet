...
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"fjet1MassPruned",5,40,0,200)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"fjet1.Pt()",5,55,250,1000,1)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"bdt_pTOverM",10,40,-1.,1.)'
...
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,2,"fjet1MassPruned",2,40,0,200)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,2,"fjet1.Pt()",2,35,250,1000,1)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,2,"bdt_pTOverM",11,40,-1.,1.)'
...
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,3,"fjet1MassPruned",3,40,0,200)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,3,"fjet1.Pt()",3,45,250,1000,1)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,3,"bdt_pTOverM",12,40,-1.,1.)'
...
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,4,"fjet1MassPruned",4,40,0,200)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,4,"fjet1.Pt()",4,55,250,1000,1)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,4,"bdt_pTOverM",13,40,-1.,1.)'
