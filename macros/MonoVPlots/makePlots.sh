...
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"metRaw",6,55,250,1000,1)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"fjet1.M()",6,40,0,200)'
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,1,"fjet1.Pt()",6,55,250,1000,1)'
fi
if [ $1 = "zll" ] || [ $1 = "all" ];
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,2,"met",7,55,250,1000,1)'
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,2,"fjet1.Pt()",7,55,250,1000,1)'
fi
if [ $1 = "wlv" ] || [ $1 = "all" ];
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,3,"met",8,55,250,1000,1)'
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,3,"fjet1.Pt()",8,55,250,1000,1)'
fi
if [ $1 = "pj" ] || [ $1 = "all" ];
then
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,4,"met",9,75,250,1000,1)'
  ...
  root -b -q ../rootlogon_monojet.C makeRawPlot.C+'(19700,4,"fjet1.Pt()",9,75,250,1000,1)'
fi
