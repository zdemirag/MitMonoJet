...
class MitGPTree {
 public:
  ...
  LorentzVector  lep1_;
  int            lid1_;
  int		 lep1IsGlobalTrackerMuon_;
  int		 lep1IsTightMuon_;
  int		 lep1IsIsolated_;
  float          lep1PtErr_;
  LorentzVector  lep2_;
  int            lid2_;
  int		 lep2IsGlobalTrackerMuon_;
...
/*   LorentzVector  pho4_; */
 ...
 public:
  ...
  void CreateTree(int type = -1){
    ...
    tree_->Branch("lep1IsGlobalTrackerMuon"         , &lep1IsGlobalTrackerMuon_         ,   "lep1IsGlobalTrackerMuon/I");
    ...
    tree_->Branch("lep2IsGlobalTrackerMuon"         , &lep2IsGlobalTrackerMuon_         ,   "lep2IsGlobalTrackerMuon/I");
...
/*     tree_->Branch("pho4"         , "ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >", &phoPtr4_); */
  ...
  void InitTree(int type = -1){
    ...
    tree_->SetBranchAddress("lep1IsGlobalTrackerMuon",&lep1IsGlobalTrackerMuon_);
    ...
    tree_->SetBranchAddress("lep2IsGlobalTrackerMuon",&lep2IsGlobalTrackerMuon_);
...
MitGPTree::InitVariables(){
  ...
  lep1_       	 = LorentzVector();
  lid1_          = 0;
  lep1IsGlobalTrackerMuon_ = 0;
  lep1IsTightMuon_ = 0;
  lep1IsIsolated_ = 0;
  lep1PtErr_     = 999.;
  lep2_       	 = LorentzVector();
  lid2_          = 0;
  lep2IsGlobalTrackerMuon_ = 0;
  lep2IsTightMuon_ = 0;
  lep2IsIsolated_ = 0;
  lep2PtErr_     = 999.;
  lep3_       	 = LorentzVector();
